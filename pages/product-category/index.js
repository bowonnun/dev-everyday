...
class ProductsCatgory extends Component {
  ...
  myFunction1 = async (e, i) => {
    ...
    if (e.target.checked) {
      ...
      this.setState({ item: item, title: e.target.dataset.target })
                                ...
                                <div className='gorupfillter-item'>
                                  <label className="fillter-item" for={`checkbox-${index_2}`} >
                                    <div className='groupCheckbox'>
                                      <input type="radio" id={`checkbox-${index_2}`} value={fillterItem.databaseId} data-target={fillterItem.name} name="category" onChange={(e) => this.myFunction1(e, index_2)} />
                                        ...
                                        if (this.state.menuOrder.includes(index_2))
                                          return (
                                            <label className="fillter-item" for={`Child_${index_2}_checkbox-${i}`} >
                                              <div className='groupCheckbox'>
                                                <input type="radio" id={`Child_${index_2}_checkbox-${i}`} name="sub-catagory" data-target={index.name} value={index.databaseId} onChange={(e) => this.myFunction1(e, index_2)} />
                                                <span className='checkmark' />
                                              </div>
                                              <p
                                                className='fillterName'
